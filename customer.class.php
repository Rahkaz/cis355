...
class Customer {
    ...
    //during the create a record this is where we varify that the name, email and number follow certain protocols
    ...
    //This is the actual code for the frame of out HTML website that happens wholy in the background through functions we call in php
